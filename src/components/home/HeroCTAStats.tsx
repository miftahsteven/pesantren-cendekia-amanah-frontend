    ...
    <div className="space-y-8 pt-6 pb-2">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 sm:p-8 bg-white rounded-2xl sm:rounded-3xl border border-[#DDE6F1] shadow-xs">
        <div className="space-y-1.5 text-center md:text-left">
          <span className="text-xs font-bold text-[#D8232A] tracking-wider uppercase">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full text-xs sm:text-sm font-bold text-[#D8232A] bg-white border-2 border-[#D8232A] hover:bg-[#FDE8E9] transition-all transform hover:-translate-y-0.5 active:translate-y-0"
          >
            <Play className="w-4 h-4 fill-[#D8232A]" />
